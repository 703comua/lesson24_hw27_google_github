...
Route::get('/', function (){
    ...
    return view('welcome', ['googleUrl' => $googleUrl, 'githubUrl' => $githubUrl]);
})->name('home');
Route::get('/github-callback', '\App\Http\Controllers\GithubController@callback')->name('github-callback');
Route::get('/google-callback', '\App\Http\Controllers\GoogleController@callback')->name('google-callback');
